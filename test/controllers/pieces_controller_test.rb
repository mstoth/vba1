...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference("Piece.count") do
      post pieces_url, params: { piece: { composer: @piece.composer, concert_id: @piece.concert_id, length: @piece.length, title: @piece.title } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { composer: @piece.composer, concert_id: @piece.concert_id, length: @piece.length, title: @piece.title } }
