...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference("Concert.count") do
      post concerts_url, params: { concert: { date: @concert.date, group_id: @concert.group_id, title: @concert.title, venue_id: @concert.venue_id } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date: @concert.date, group_id: @concert.group_id, title: @concert.title, venue_id: @concert.venue_id } }
